      ...
      <div className="navbar max-w-7xl mx-auto">
        ...
        <div className="navbar-center hidden lg:flex">
          <ul className="menu menu-horizontal px-1">
            <li>
              <NavLink className="text-white hover:text-amber-600 hover:bg-amber-50" to="/">
                Home
              </NavLink>
            </li>
            <li>
              <NavLink className="text-white hover:text-amber-600 hover:bg-amber-50" to="/all-artifacts">
                All-Artifacts
              </NavLink>
            </li>
            <li>
              <NavLink className="text-white hover:text-amber-600 hover:bg-amber-50" to="/add-artifacts">
                Add-Artifacts
              </NavLink>
            </li>
            ...
            {user && (
              <>
                <li>
                  <NavLink className="text-white hover:text-amber-600 hover:bg-amber-50" to={`/shareartifacts/${user.email}`}>
                    My-Artifacts
                  </NavLink>
                </li>
                <li>
                  <NavLink className="text-white hover:text-amber-600 hover:bg-amber-50" to={`/liked-artifacts/${user.email}`}>
                    Liked Artifacts
                  </NavLink>
                </li>
              </>
          ...
          {user ? (
            <div className="dropdown dropdown-end">
              ...
              >
                ...
                <li>
                  <NavLink to={`/shareartifacts/${user?.email}`}>My-Artifacts</NavLink>
                </li>
                <li>
                  <NavLink to={`/liked-artifacts/${user?.email}`}>Liked Artifacts</NavLink>
                </li>
                <li>
